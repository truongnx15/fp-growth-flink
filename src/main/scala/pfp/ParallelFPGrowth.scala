...
object ParallelFPGrowth {
  ...
  /**
    ...
    * @param minCount
    */
  class ParallelFPGrowthFlatMap(val idToGroupMap : mutable.HashMap[Int, Int], val order : Map[Item, Int], val gList: mutable.HashMap[Item, Int], val minCount: Long) extends FlatMapFunction[Itemset[Item], (Int, ArrayBuffer[Int])] {

    override def flatMap(itemset: Itemset[Item], collector: Collector[(Int, ArrayBuffer[Int])]): Unit = {
      ...
      val itemIds = itemset.items.flatMap(order.get).sortWith( _ > _)
  ...
  class ParallelFPGrowthGroupReduce(val idToGroupMap: mutable.HashMap[Int, Int], val minCount: Long) extends GroupReduceFunction[(Int, ArrayBuffer[Int]), Itemset[Int]] {
    override def reduce(iterable: Iterable[(Int, ArrayBuffer[Int])], collector: Collector[Itemset[Int]]): Unit = {
